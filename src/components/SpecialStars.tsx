  ...
  if (u === "thevip") {
    return (
      <div className="flex min-w-0 flex-col gap-0.5 sm:flex-row sm:flex-wrap sm:items-center sm:gap-x-1.5">
        ...
        >
          {[0, 1, 2, 3, 4].map((i) => (
            ...
            >
              <svg
                viewBox="0 0 24 24"
                className="h-full w-full fill-[#C9A86C] drop-shadow-sm"
              >
        ...
        <span
          className="text-[11px] font-medium leading-snug text-[#C9A86C] sm:text-[12px] sm:leading-none"
          style={{ fontFamily: "Times New Roman, Times, serif" }}
        >
        ...
        >
          {[0, 1, 2, 3, 4].map((i) => (
            ...
            >
              <svg
                viewBox="0 0 24 24"
                className="h-full w-full fill-[#E8A0BF] drop-shadow-sm"
              >
                <path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z" />
              </svg>
              <svg
